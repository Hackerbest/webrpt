const mockSongs = [
  { id: 1, title: "Summer Vibes", artist: "RAPEEPHAT REMIX", price: 300, duration: "3:45", durationSecs: 225, category: "178" },
  { id: 2, title: "Night Drive", artist: "RAPEEPHAT REMIX", price: 300, duration: "4:20", durationSecs: 260, category: "170" },
  { id: 3, title: "Sunset Dreams", artist: "RAPEEPHAT REMIX", price: 300, duration: "3:55", durationSecs: 235, category: "190" },
  { id: 4, title: "City Lights", artist: "RAPEEPHAT REMIX", price: 300, duration: "4:10", durationSecs: 250, category: "168" },
  { id: 5, title: "Ocean Breeze", artist: "RAPEEPHAT REMIX", price: 300, duration: "3:30", durationSecs: 210, category: "180" },
  { id: 6, title: "Midnight Jazz", artist: "RAPEEPHAT REMIX", price: 300, duration: "5:15", durationSecs: 315, category: "195" },
  { id: 7, title: "Electric Soul", artist: "RAPEEPHAT REMIX", price: 300, duration: "4:05", durationSecs: 245, category: "200" },
  { id: 8, title: "Morning Coffee", artist: "RAPEEPHAT REMIX", price: 300, duration: "3:40", durationSecs: 220, category: "160" }
];
...
function renderSongs() {
  document.getElementById("songGrid").innerHTML = mockSongs.map(song => {
  ...
  document.getElementById("productList").innerHTML = mockSongs.map(song => {
    const active = playingId === `mock-${song.id}`;
    return `
      <article class="product-card">
        <div class="product-row">
          <div class="product-cover">♫${active ? `<div class="bouncing"><span></span><span></span><span></span><span></span><span></span></div>` : ""}</div>
...
function seekToPercent(percent) {
  ...
  if (playingId.startsWith("free-") && audio.duration) {
...
document.getElementById("addGithubBtn").addEventListener("click", addGithubUrl);
document.getElementById("githubUrl").addEventListener("keydown", e => { if (e.key === "Enter") addGithubUrl(); });
...
document.getElementById("pauseBtn").addEventListener("click", () => {
  if (!playingId) return;
  if (playingId.startsWith("free-")) audio.pause();
  stopMockTimer();
  stopProgressLoop();
  playingId = null;
  updatePlayer();
